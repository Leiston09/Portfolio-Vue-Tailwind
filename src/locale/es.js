export default {
  ...
  home: {
    ...
    welcomeMessage:
      "Desarrollador frontend de Ecuador, especializado en Vue 3 y TypeScript. Actualmente expandiendo mis conocimientos hacia el stack full-stack con Node.js y bases de datos, integrando también formación en ciberseguridad y redes para un desarrollo más completo.",
    ViewProjects: "Ver Proyectos",
    ViewCV: "Ver Currículum",
    ViewContact: "Ver Contacto",
    specialization: {
      webDeveloper: "Desarrollador Frontend",
    ...
    personalMessage:
      "Apasionado por el desarrollo web y el aprendizaje continuo. Me dedico a construir interfaces modernas, funcionales y escalables, mientras sigo fortaleciendo mis habilidades en nuevas tecnologías para aportar soluciones de alto valor.",
  },
  ...
  projects: {
    ...
    items: {
      portfolio: {
        ...
        description:
          "Portafolio web moderno diseñado para presentar mi perfil, proyectos y habilidades de desarrollo.",
        descriptionimg:
  ...
  login: {
    ...
    register: {
      title: "Crear cuenta",
      intro: "Regístrate para acceder al sistema",
    ...
    recoverPassword: {
      ...
      description: "Ingresa tu correo para recuperar tu cuenta",
  ...
  chatBot: {
    Welcome: "Bienvenido al portafolio. ¿Qué te gustaría conocer?",
  },
};
