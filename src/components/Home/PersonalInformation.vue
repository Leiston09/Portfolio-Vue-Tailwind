<template>
  <div
    class="bg-[#111827] rounded-2xl overflow-hidden 
    shadow-md hover:shadow-2xl shadow-sky-900/50 
  ...
  >
    ...
    <div class="p-4 flex flex-col gap-3">
      <h1 class="font-mono text-xl text-white">Leiston Holguin Aguirre</h1>
      <ul class="flex flex-wrap gap-2 text-xs">
        <li class="bg-[#1E293B] px-2 py-1 rounded-lg text-gray-300 hover:scale-105 transition-all duration-200">
      ...
      <button
        class="bg-[#38BDF8] text-black/90 font-extrabold rounded-lg py-2 mt-2 hover:scale-105 transition-all duration-200">
        {{ $t("home.DownloadCV") }}
      </button>
    </div>
  </div>
