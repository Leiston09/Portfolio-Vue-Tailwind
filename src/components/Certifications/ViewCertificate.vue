<template>
  ...
  <div
    v-else
    class="fixed inset-0 bg-black/60 backdrop-blur-md z-50 overflow-y-auto"
  >
    <div
      class="min-h-screen flex items-center sm:items-center justify-center p-2 sm:p-4"
    >
      <div class="w-full max-w-7xl mx-auto my-4 sm:my-8 lg:my-0">
        <div
          class="grid grid-cols-1 lg:grid-cols-2 gap-2 lg:gap-6 bg-black/85 rounded-xl overflow-hidden shadow-2xl"
        >
          <div
            class="w-full flex justify-center items-center overflow-hidden bg-neutral-900"
          >
            <img
